...
# Controls are written below; the placeholder is filled after params are collected.
...
with col_tip:
    st.caption("Adjust any parameter above and the preview updates automatically.")
